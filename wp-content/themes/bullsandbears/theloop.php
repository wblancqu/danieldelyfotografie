...
<h1><?php the_title(); ?></h1>
			<?php } ?>
			<?php if (!is_page()) {?><p><?php echo get_the_date(); ?> <img alt="" src="<?php echo get_template_directory_uri(); ?>/images/smt/category.png"><?php the_category(',&nbsp;'); ?>
			<?php if(comments_open( get_the_ID() ))  {
                ...
                ?><?php edit_post_link( $SMTheme->_( 'edit' ), '&nbsp;&nbsp;|&nbsp;&nbsp;<span class="edit-link">', '</span>' ); ?></p> <?php } ?>
		</dt>
		<dd>
			<?php
